		...
		((E.ctx = t
			? t(e, u.props || {}, (f, d, ...h) => {
					...
					return (
						E.ctx &&
							s(E.ctx[f], (E.ctx[f] = o)) &&
							(!E.skip_bound && E.bound[f] && E.bound[f](o),
							_ && Zs(e, f)),
						d
					);
				})
	...
	if (a > 1 && a < 9) {
		if (((t.language = r.slice(0, a)), a < 4)) {
			...
			for (
				...
				(t.extendedLanguageSubtags.push(r.slice(a + 1, a + 4)),
					(a += 4),
					n++);
			}
		}
...
function ea(e) {
	...
	return {
		c() {
			((u = v('li')),
				s.c(),
				C(u, 'class', 'pagefind-ui__result svelte-j9e30'));
		},
		m(a, l) {
			(k(a, u, l), s.m(u, null));
		},
...
function ua(e, u, t) {
	...
	const E = async (f) => {
			(t(1, (n = await f.data())),
				...
				t(
					2,
					(i = Object.entries(n.meta).filter(([d]) => !l.includes(d)))
				));
		},
	...
	const f = (o, c) => {
		...
		d = async (o) => {
			(t(1, (n = await o.data())),
				...
				t(
					2,
					(i = Object.entries(n.meta).filter(([c]) => !l.includes(c)))
				),
				Array.isArray(n.sub_results) &&
					(t(
						4,
						(_ = n.sub_results?.[0]?.url === (n.meta?.url || n.url))
					),
					_
	...
	return {
		c() {
			...
			((E = M()),
				...
				(u.open = _ =
					e[7] || e[3].map(iu).includes(e[10].toLowerCase())));
		},
		m(h, o) {
			(k(h, u, o),
				R(u, t),
		...
		p(h, o) {
			...
			o & 138 &&
				_ !==
					(_ = h[7] || h[3].map(iu).includes(h[10].toLowerCase())) &&
				(u.open = _);
		},
		d(h) {
			(h && p(u), ie(d, h));
		...
		(e.$$set = (h) => {
			('available_filters' in h && t(1, (r = h.available_filters)),
				...
				'automatic_translations' in h &&
					t(5, (n = h.automatic_translations)),
...
function il(e) {
	let u =
			e[20]('many_results', e[19], e[7])
				...
				.replace(
					/\[COUNT\]/,
					new Intl.NumberFormat(e[7].language).format(
						e[13].results.length
					)
				) + '',
		t;
...
function ol(e) {
	let u =
			e[20]('one_result', e[19], e[7])
				...
				.replace(
					/\[COUNT\]/,
					new Intl.NumberFormat(e[7].language).format(1)
				) + '',
		t;
	return {
		c() {
...
function _l(e) {
	let u =
			e[20]('zero_results', e[19], e[7]).replace(
				/\[SEARCH_TERM\]/,
				e[16]
			) + '',
		t;
...
function hu(e) {
	let u,
		t =
			e[20]('searching', e[19], e[7]).replace(/\[SEARCH_TERM\]/, e[16]) +
			'',
		r;
	return {
		c() {
...
function fl(e) {
	...
	return {
		...
		p(T, D) {
			((!o ||
				(D[0] & 524416 &&
					s !== (s = T[20]('placeholder', T[19], T[7])))) &&
				C(r, 'placeholder', s),
				(!o ||
					(D[0] & 524416 &&
						a !== (a = T[20]('placeholder', T[19], T[7])))) &&
					C(r, 'title', a),
				...
				(!o ||
					(D[0] & 524416 &&
						h !== (h = T[20]('search_label', T[19], T[7])))) &&
					C(t, 'aria-label', h),
	...
	return (
		(e.$$set = (m) => {
			('base_path' in m && t(25, (a = m.base_path)),
				...
				'debounce_timeout_ms' in m &&
					t(28, (c = m.debounce_timeout_ms)),
				'pagefind_options' in m && t(29, (g = m.pagefind_options)),
				'merge_index' in m && t(30, (A = m.merge_index)),
				'trigger_search_term' in m &&
					t(23, (B = m.trigger_search_term)),
