				...
				createClass(
					...
					[
						...
						},
						{
							...
							value: function observeIframeLoad(
								ifr,
								successFn,
								errorFn
							) {
						...
						},
						{
							...
							value: function compareNodeIframe(
								node,
								prevNode,
								ifr
							) {
								var compCurr =
										node.compareDocumentPosition(ifr),
						...
						},
						{
							...
							value: function checkIframeFilter(
								node,
								prevNode,
								currIfr,
								ifr
						...
						},
						{
							...
							value: function handleOpenIframes(
								ifr,
								whatToShow,
								eCb,
								fCb
			...
			var Mark$1 = (function () {
				...
				createClass(Mark3, [
					...
					},
					{
						...
						value: function createJoinersRegExp(str) {
							...
							if (
								...
								joiner.push(
									this.escapeStr(ignorePunctuation.join(''))
								);
							}
					...
					},
					{
						...
						value: function createAccuracyRegExp(str) {
							...
							var acc = this.opt.accuracy,
								...
								ls =
									typeof acc === 'string' ? [] : acc.limiters,
								lsJoin = '';
							...
							array
								...
								.forEach(function (item) {
									var _callNoMatchOnInvalid =
											_this3.callNoMatchOnInvalidRanges(
												item,
												last
											),
					...
					},
					{
						...
						value: function callNoMatchOnInvalidRanges(
							range,
							last
						) {
							var start = void 0,
					...
					},
					{
						...
						value: function getTextNodes(cb) {
							...
							this.iterator.forEachNode(
								...
								function (node) {
									if (
										_this4.matchesExclude(node.parentNode)
									) {
						...
						value: function wrapRangeInMappedTextNode(
							...
							dict.nodes.every(function (n, i) {
								...
								if (
									...
									n.node = _this5.wrapRangeInTextNode(
										n.node,
										s,
										e
									);
					...
					},
					{
						...
						value: function wrapMatches(
							...
							var _this6 = this;
							var matchIdx =
								ignoreGroups === 0 ? 0 : ignoreGroups + 1;
					...
					},
					{
						...
						value: function markRegExp(regexp, opt) {
							...
							this.opt = opt;
							this.log(
								'Searching with expression "' + regexp + '"'
							);
							var totalMatches = 0,
								fn = 'wrapMatches';
					...
					},
					{
						...
						value: function unmark(opt) {
							...
							this.iterator.forEachNode(
								...
								function (node) {
									var matchesSel = DOMIterator.matches(
											node,
											sel
										),
										matchesExclude =
...
var PagefindHighlight = class {
	constructor(
		...
		(_a = this.markOptions).className ??
			(_a.className = 'pagefind__highlight');
