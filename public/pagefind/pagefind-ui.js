(() => {
	...
	var Hn =
		...
		de = class {
			constructor(e) {
				((this.options = e),
					(this._listeners =
						'WeakMap' in Hn ? new WeakMap() : void 0));
			}
			observe(e, t) {
				return (
					...
					: (this._observer = new ResizeObserver((t) => {
							...
							for (let s of t)
								(de.entries.set(s.target, s),
									(r = this._listeners.get(s.target)) ===
										null ||
										r === void 0 ||
										r(s));
						}));
			...
			((f.ctx = t
				? t(n, e.props || {}, (d, p, ...h) => {
						...
						return (
							f.ctx &&
								s(f.ctx[d], (f.ctx[d] = u)) &&
								(!f.skip_bound && f.bound[d] && f.bound[d](u),
								c && Gr(n, d)),
							p
						);
					})
			...
			c() {
				((e = C('img')),
					...
					m(
						e,
						'alt',
						(r = n[1].meta?.image_alt || n[1].meta?.title)
					));
			},
			m(s, l) {
				S(s, e, l);
		...
		let { show_images: r = !0 } = e,
			...
			f = async (d) => {
				(t(1, (a = await d.data())),
					...
					t(
						2,
						(o = Object.entries(a.meta).filter(
							([p]) => !i.includes(p)
						))
					));
			},
		...
		return {
			c() {
				...
				(m(
					t,
					'class',
					'pagefind-ui__filter-panel-label svelte-1v2r7ls'
				),
			...
			c() {
				((e = C('div')),
					...
					m(
						t,
						'class',
						'pagefind-ui__filter-checkbox svelte-1v2r7ls'
					),
					m(t, 'type', 'checkbox'),
					m(t, 'id', (r = n[10] + '-' + n[14])),
					m(t, 'name', (s = n[10])),
			...
			p(h, u) {
				...
				u & 138 &&
					c !==
						(c =
							h[7] ||
							h[3].map(_r).includes(h[10].toLowerCase())) &&
					(e.open = c);
			},
			d(h) {
				(h && k(e), Q(p, h));
		...
		return (
			(n.$$set = (h) => {
				('available_filters' in h && t(1, (r = h.available_filters)),
					'show_empty_filters' in h &&
						t(2, (s = h.show_empty_filters)),
					'open_filters' in h && t(3, (l = h.open_filters)),
					'translate' in h && t(4, (i = h.translate)),
					'automatic_translations' in h &&
						t(5, (a = h.automatic_translations)),
	...
	var Ul = 'Adam Laki <info@adamlaki.com>',
		...
		Pl = {
			...
			many_results:
				'[COUNT] db tal\xE1lat a(z) [SEARCH_TERM] kifejez\xE9sre',
			one_result:
				'[COUNT] db tal\xE1lat a(z) [SEARCH_TERM] kifejez\xE9sre',
			alt_search:
	...
	function oo(n) {
		let e =
				n[20]('many_results', n[19], n[7])
					...
					.replace(
						/\[COUNT\]/,
						new Intl.NumberFormat(n[7].language).format(
							n[13].results.length
						)
					) + '',
			t;
	...
	function co(n) {
		let e =
				n[20]('zero_results', n[19], n[7]).replace(
					/\[SEARCH_TERM\]/,
					n[16]
				) + '',
			t;
	...
	function br(n) {
		let e,
			t =
				n[20]('searching', n[19], n[7]).replace(
					/\[SEARCH_TERM\]/,
					n[16]
				) + '',
			r;
	...
	function ho(n) {
		...
		return {
			...
			p(M, y) {
				((!u ||
					(y[0] & 524416 &&
						s !== (s = M[20]('placeholder', M[19], M[7])))) &&
					m(r, 'placeholder', s),
					(!u ||
						(y[0] & 524416 &&
							l !== (l = M[20]('placeholder', M[19], M[7])))) &&
						m(r, 'title', l),
					...
					(!u || y[0] & 524416) &&
						...
						z(f, o),
					(!u || y[0] & 512) &&
						B(a, 'pagefind-ui__suppressed', !M[9]),
					M[12]
						? b
...
`)
			...
			An = async () => {
				for (; !F; )
					(Mn(), await new Promise((g) => setTimeout(g, 50)));
			},
			yr = async (g, N) => {
				(t(16, (Cn = g || '')),
		...
		return (
			(n.$$set = (g) => {
				('base_path' in g && t(25, (l = g.base_path)),
					...
					'show_empty_filters' in g &&
						t(5, (h = g.show_empty_filters)),
					'open_filters' in g && t(6, (u = g.open_filters)),
					'debounce_timeout_ms' in g &&
						t(28, (_ = g.debounce_timeout_ms)),
					'pagefind_options' in g && t(29, (E = g.pagefind_options)),
					'merge_index' in g && t(30, (b = g.merge_index)),
					'trigger_search_term' in g &&
						t(23, (T = g.trigger_search_term)),
